...
public class FTPServerService extends Service implements Runnable {
	...
	public static final String WAKE_LOCK_TAG = "PrivilegeFTP";
...
//	protected static InetAddress serverAddress = null;
	...
	public void onCreate() {
		myLog.l(Log.DEBUG, "PrivilegeFTP server created");
...
//				serverAddress = null;
		...
		myLog.l(Log.INFO, "PrivilegeFTP server ready");
		setupNotification();
	...
	private void takeWifiLock() {
		...
		if(wifiLock == null) {
			...
			wifiLock = manager.createWifiLock("PrivilegeFTP");
